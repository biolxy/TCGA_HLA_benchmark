##################################################
# File Name     : 3.6.batch.hlagenotyper_pipeline.sh 
# Author      : biolxy
...
python /home/lixy/production/2018-10-23_other_4_pipeline/util/hlagenotyper_v02.py -w ${conffile} -s ${bamdir} -d ${outputdir} 
