...
ax = kmf_exp.fit(np.array(T_high), label='B44.present').plot(ax=ax,ci_show=True,linewidth=3)
...
ax = kmf_control.fit(np.array(T_low), label='B44.absent').plot(ax=ax,ci_show=True,linewidth=3)
...
text0_1 = 'B44.present vs B44.absent'
...
plt.savefig("Allen_melanoma_b44.png", dpi=330)
#plt.show()