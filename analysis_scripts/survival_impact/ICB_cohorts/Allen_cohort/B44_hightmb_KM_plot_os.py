...
ax = plt.subplot(111)
data = open(r'Allen_survival.txt','r')
...
ax.text(0.658, 0.8, textstr, transform=ax.transAxes, fontsize=13,horizontalalignment='center', verticalalignment='top', bbox=props)
ax.set_ylim(0,1.0)
ax.set_xlim(0,54)
#ax.set_ylabel('Probability of OS(Months)  ', fontsize = 16)
ax.set_ylabel('Probability of overall survival  ', fontsize = 18)
ax.set_xlabel('Month',fontsize=18)
plt.savefig("Allen_b44_highlowTMB.pdf", dpi=330)
#plt.show()